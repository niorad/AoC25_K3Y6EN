...
static const GuiStyleProp cyberStyleProps[CYBER_STYLE_PROPS_COUNT] = {
    { 0, 0,static_cast<int>(0x2f7486ff)},    // DEFAULT_BORDER_COLOR_NORMAL
    { 0, 1,static_cast<int>(0x024658ff)},    // DEFAULT_BASE_COLOR_NORMAL
    { 0, 2,static_cast<int>(0x51bfd3ff)},    // DEFAULT_TEXT_COLOR_NORMAL
    { 0, 3,static_cast<int>(0x82cde0ff)},    // DEFAULT_BORDER_COLOR_FOCUSED
    { 0, 4,static_cast<int>(0x3299b4ff)},    // DEFAULT_BASE_COLOR_FOCUSED
    { 0, 5,static_cast<int>(0xb6e1eaff)},    // DEFAULT_TEXT_COLOR_FOCUSED
    { 0, 6,static_cast<int>(0xeb7630ff)},    // DEFAULT_BORDER_COLOR_PRESSED
    { 0, 7,static_cast<int>(0xffbc51ff)},    // DEFAULT_BASE_COLOR_PRESSED
    { 0, 8,static_cast<int>(0xd86f36ff)},    // DEFAULT_TEXT_COLOR_PRESSED
    { 0, 9,static_cast<int>(0x134b5aff)},    // DEFAULT_BORDER_COLOR_DISABLED
    { 0, 10,static_cast<int>(0x02313dff)},    // DEFAULT_BASE_COLOR_DISABLED
    { 0, 11,static_cast<int>(0x17505fff)},    // DEFAULT_TEXT_COLOR_DISABLED
    { 0, 16,static_cast<int>(0x0000000e)},    // DEFAULT_TEXT_SIZE
    { 0, 17,static_cast<int>(0x00000000)},    // DEFAULT_TEXT_SPACING
    { 0, 18,static_cast<int>(0x81c0d0ff)},    // DEFAULT_LINE_COLOR
    { 0, 19,static_cast<int>(0x00222bff)},    // DEFAULT_BACKGROUND_COLOR
    { 0, 20,static_cast<int>(0x00000015)},    // DEFAULT_TEXT_LINE_SPACING
};
